...
#' @export
mt_tune_rp <- function(data, resampling = rsmp("bootstrap", ratio = 0.8, repeats = 5), measure = msr("classif.acc"), eta = 3) {
	search_space <- ps(
...
#' @return A list of tuning instance and stage plot.
#' @export
mt_tune_rg <- function(data, resampling = rsmp("cv", folds = 5), measure = msr("classif.acc"), eta = 3) {
	search_space <- ps(
...
#' @return A list of tuning instance and stage plot.
#' @export
mt_tune_xgb <- function(data, resampling = rsmp("cv", folds = 5), measure = msr("classif.acc"), eta = 3) {
	search_space <- ps(
