...
attributes = mi_get_ID_attr(biomart = "genes", dataset = "mmusculus_gene_ensembl", mirror = "asia")
flt_attri = attributes %>% dplyr::slice(1,2,11,15)
data_ID = mi_get_ID(flt_attri,biomart = "genes", dataset = "mmusculus_gene_ensembl", mirror = "asia")
data_ID
```
...
```{r echo=FALSE, message=FALSE, hide=TRUE,cache=TRUE}
...
#%>% dplyr::slice(sample(nrow(data_blcd[[1]]), 2000), preserve = TRUE) 
test = data_blcd[[2]]
#Decision Tree
